...
namespace wardrobe.Controllers
{
    public class ClothingTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TypeID,ClothingType1,Size,Brand")] ClothingType clothingType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TypeID,ClothingType1,Size,Brand")] ClothingType clothingType)
        {
            if (ModelState.IsValid)
            {
